...
# Read train data
train_data = pd.read_csv('../attacker_data/train_attacker_2022.csv', index_col="id", skipinitialspace = True)
...
# split dataset
n_state = 45
X_train, X_test, y_train, y_test = train_test_split(train_data.drop('label', axis=1),train_data['label'], train_size = 0.8, test_size = 0.2, random_state=n_state)
